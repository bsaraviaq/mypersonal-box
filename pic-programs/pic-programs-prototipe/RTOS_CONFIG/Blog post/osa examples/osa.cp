#line 1 "C:/osa/osa examples/osa.c"
#line 1 "c:/osa/osa/osa.h"
#line 1 "c:/osa/osa examples/osacfg.h"
...
#line 1660 "c:/osa/osa/osa.h"
 extern volatile   OST_UINT _OS_Temp_I;
#line 55 "C:/osa/osa examples/osa.c"
...
#line 99 "C:/osa/osa examples/osa.c"
   OST_TCB *    volatile _OS_BestTask;
   OST_TCB *    volatile _OS_LastTask;

    OST_UINT  _OS_Best_Priority;
#line 1 "c:/osa/osa/port/osa_include.c"
#line 1 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
#line 34 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
...
#line 88 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_ClrReadySetClrCanContinue (void);
#line 106 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
...
#line 132 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_ReturnNoSave (void)
{
  asm{ pop } ;
}
#line 156 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_EnterWaitMode (void)
{
 _OS_Temp = 0;
 _OS_ClrReadySetClrCanContinue();
}
#line 181 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_EnterWaitModeTO (void)
{
 _OS_Temp = 0xFF;
 _OS_ClrReadySetClrCanContinue();
}
#line 207 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_ClrReadySetClrCanContinue (void)
{
  asm{ pop } ;
...
#line 242 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_SET_FSR_CUR_TASK (void)
{
 _fsr = ( unsigned int )_OS_CurTask;
}
#line 281 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
char OS_DI (void)
{
 char temp;
 temp = _intcon & 0xC0;
...
#line 326 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
...
#line 383 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_CheckEvent (OST_UINT bEvent)
{
#line 421 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
 ...
 if ( _OS_State.bReady ) {
  ...
  _OS_State.bDelay  = 0;
 _indf &= ~0x10;
#line 439 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
 return;
 }
...
#line 459 "c:/osa/osa/port/pic18/osa_pic18_mikroc.c"
 return;
 }
...
#line 1 "c:/osa/osa/kernel/timers/osa_dtimer.c"
#line 1 "c:/osa/osa/kernel/timers/osa_qtimer.c"
#line 1 "c:/osa/osa/kernel/timers/osa_stimer.c"
#line 1 "c:/osa/osa/kernel/timers/osa_ttimer.c"
#line 69 "c:/osa/osa/kernel/timers/osa_ttimer.c"
 void _OS_InitDelay ( OST_UINT16  Delay)
 {

   { ; _OS_State.bCanContinue  = 0; _OS_CurTask->State.bDelay = 0;; ; } ;
#line 77 "c:/osa/osa/kernel/timers/osa_ttimer.c"
 if (Delay)
 {
 Delay ^= ( OST_UINT16 )-1;
 Delay ++;
...
#line 87 "c:/osa/osa/kernel/timers/osa_ttimer.c"
  _OS_State.bDelay  = 1;
  _OS_State.bReady  = 1;

 }
 }
#line 1 "c:/osa/osa/kernel/events/osa_squeue.c"
#line 1 "c:/osa/osa/kernel/events/osa_queue.c"
#line 1 "c:/osa/osa/kernel/events/osa_csem.c"
#line 1 "c:/osa/osa/kernel/events/osa_bsem.c"
#line 1 "c:/osa/osa/kernel/system/osa_system.c"
#line 67 "c:/osa/osa/kernel/system/osa_system.c"
void OS_Init (void)
{
...
#line 326 "c:/osa/osa/kernel/system/osa_system.c"
...
#line 394 "c:/osa/osa/kernel/system/osa_system.c"
}
#line 1 "c:/osa/osa/kernel/system/osa_tasks.c"
#line 36 "c:/osa/osa/kernel/system/osa_tasks.c"
  OST_TCB _OS_Tasks[ 3 ]  ;
#line 75 "c:/osa/osa/kernel/system/osa_tasks.c"
 void _OS_Task_Create( OST_UINT  priority,  unsigned long  TaskAddr)
 {
   OST_TCB *  Task;

 _OS_Flags.bError = 0;
#line 88 "c:/osa/osa/kernel/system/osa_tasks.c"
 ...
 Task->Timer = 0;
#line 108 "c:/osa/osa/kernel/system/osa_tasks.c"
 *((  char*)&Task->State) = priority;


 if (Task == _OS_CurTask) *((  char*)&_OS_State) = priority;
#line 126 "c:/osa/osa/kernel/system/osa_tasks.c"
 _OS_Flags.bError = 0;
