#line 1 "C:/Users/Nouman Qaiser/Documents/Embedded Systems/Blog post/osa/osa.c"
...
#line 55 "C:/Users/Nouman Qaiser/Documents/Embedded Systems/Blog post/osa/osa.c"
 volatile   OST_SYSTEM_FLAGS _OS_Flags;
    OST_UINT  _OS_Temp;
#line 63 "C:/Users/Nouman Qaiser/Documents/Embedded Systems/Blog post/osa/osa.c"
...
#line 120 "C:/Users/Nouman Qaiser/Documents/Embedded Systems/Blog post/osa/osa.c"
   OST_UINT _OS_Best_Priority;
   OST_UINT _OS_Worst_Priority;
   OST_UINT _OS_Best_n;
   OST_UINT _OS_Cur_Pos;
   OST_UINT _OS_n;
   OST_UINT8 _OS_TaskQueue[ 4 ];
   OST_UINT8 _OS_TaskLevel[ 4 ];
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/osa_include.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
#line 34 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
...
#line 88 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_ClrReadySetClrCanContinue (void);
#line 106 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
...
#line 132 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_ReturnNoSave (void)
{
  asm{ pop } ;
}
#line 156 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_EnterWaitMode (void)
{
 _OS_Temp = 0;
 _OS_ClrReadySetClrCanContinue();
}
#line 181 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_EnterWaitModeTO (void)
{
 _OS_Temp = 0xFF;
 _OS_ClrReadySetClrCanContinue();
}
#line 207 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_ClrReadySetClrCanContinue (void)
{
  asm{ pop } ;
...
#line 242 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_SET_FSR_CUR_TASK (void)
{
 _fsr = ( unsigned int )_OS_CurTask;
}
#line 281 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
char OS_DI (void)
{
 char temp;
 temp = _intcon & 0xC0;
...
#line 326 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
...
#line 383 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
void _OS_CheckEvent (OST_UINT bEvent)
{
#line 421 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/port/pic18/osa_pic18_mikroc.c"
...
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/timers/osa_dtimer.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/timers/osa_qtimer.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/timers/osa_stimer.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/timers/osa_ttimer.c"
#line 69 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/timers/osa_ttimer.c"
 void _OS_InitDelay ( OST_UINT32  Delay)
 {

   { ; _OS_State.bCanContinue  = 0; _OS_CurTask->State.bDelay = 0;; ; } ;
#line 77 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/timers/osa_ttimer.c"
 if (Delay)
 {
 Delay ^= ( OST_UINT32 )-1;
 Delay ++;
...
#line 87 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/timers/osa_ttimer.c"
  _OS_State.bDelay  = 1;
  _OS_State.bReady  = 1;

 }
 }
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/events/osa_squeue.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/events/osa_queue.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/events/osa_csem.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/events/osa_bsem.c"
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_system.c"
#line 67 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_system.c"
void OS_Init (void)
{
 ...
 *(   OST_UINT *)&_OS_Flags = 0;
  ...
  ;
#line 326 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_system.c"
...
#line 379 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_system.c"
  ;
...
#line 1 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_tasks.c"
#line 36 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_tasks.c"
  OST_TCB _OS_Tasks[ 4 ]  ;
#line 75 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_tasks.c"
 void _OS_Task_Create( OST_UINT  priority,  unsigned long  TaskAddr)
 {
   OST_TCB *  Task;

 _OS_Flags.bError = 0;
#line 88 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_tasks.c"
 ...
 Task->Timer = 0;
#line 108 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_tasks.c"
 *((  char*)&Task->State) = priority;


 if (Task == _OS_CurTask) *((  char*)&_OS_State) = priority;
#line 126 "c:/users/nouman qaiser/documents/embedded systems/blog post/osa/kernel/system/osa_tasks.c"
 _OS_Flags.bError = 0;
